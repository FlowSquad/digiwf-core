package io.muenchendigital.digiwf.example.api;
...
public class HelperController {
    ...
    /**
     * Example Controller to send a test message to the {@link io.muenchendigital.digiwf.example.ExampleIntegration} integration.
     */
    @GetMapping
    public void test() {
